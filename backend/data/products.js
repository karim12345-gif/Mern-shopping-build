const products = [
  ...
  },
  {
    name: "Amazon Alexa",
    imageUrl:
      "https://images.squarespace-cdn.com/content/v1/59937b8f2994cae8c280ca6c/1507306990873-XTKG8NSIUQX3O5ICBU9X/61yI7vWa83L._SL1000_.jpg?format=500w",
    description:
  ...
  },
  {
    name: "Apple watch 7",
    imageUrl:
      "https://b2c-contenthub.com/wp-content/uploads/2021/05/apple-watch-s7-rumors03.jpg?quality=50&strip=all&w=1200",
    description: "The all newest apple watch 7",
    price: 600,
    countInStock: 10,
  },
  {
    name: "Smart WiFi Wireless Essential Oil Aromatherapy 400ml Ultrasonic Diffuser & Humidifier with Alexa & Google Home Phone App & Voice Control ",
    imageUrl: "https://m.media-amazon.com/images/I/71CZC695rvL._AC_SL1500_.jpg",
    description:
      "A SMARTER DIFFUSER A great addition to your smart home that is powered intelligently and wi-fi compatible. Use it like a normal diffuser or download the companion app to control features like LED color, mist intensity, timer settings, scheduling and more directly from your phone. Our smart diffuser is also Alexa and Google Home compatible and can be used with to control simply by using your voice. A large 400ml water tank allows for up to 12 hours of continuous mist. Our beautiful diffuser works by creating 360° ultra sonic frequencies that instantly atomize water and oil molecules into the air. The result is a much healthier alternative than older style heat diffusers that can damage essential oils during the heat diffusion process ",
    price: 200,
    countInStock: 10,
  },
];
...
// importing our data into the database
